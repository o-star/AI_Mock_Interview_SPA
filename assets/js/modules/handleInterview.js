...
const handleInterview = () => {
  ...
  let recordScreen = document.getElementById('interview-screen')
  let viewScreen = document.getElementById('result-screen')
  ...
  $('#next-btn').click(() => {
    historyRouterPush('/interview', rootElement)
  })

  $('#interview-fin-btn').click(() => {
    historyRouterPush('/', rootElement)
  })
}

export default handleInterview